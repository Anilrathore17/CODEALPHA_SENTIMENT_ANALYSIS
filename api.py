...
def predict():
    ...
    predictor = pickle.load(open(r"Sentiment-Analysis/Models/model_xgb.pkl", "rb"))
    scaler = pickle.load(open(r"Sentiment-Analysis/Models/scaler.pkl", "rb"))
    cv = pickle.load(open(r"Sentiment-Analysis/Models/countVectorizer.pkl", "rb"))
    try:
